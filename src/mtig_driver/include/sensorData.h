...
private:
	...
	float mgpsVelocityX, mgpsVelocityY, mgpsVelocityZ;
...
public:
	...
	float gps_velocity_x() { return mgpsVelocityX; }
	float gps_velocity_y() { return mgpsVelocityY; }
	float gps_velocity_z() { return mgpsVelocityZ; }
